...
const CallToAction = () => {
    return (
        <>
            <div id='cta' class="max-w-5xl mx-2 md:mx-auto p-px mt-16 ">
                <div class="flex flex-col items-center justify-center text-center py-12 md:py-16  ">
                    <div class="flex items-center justify-center bg-[#289db9] px-3 py-1.5 shadow gap-1 rounded-full text-xs my-12">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="#white" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M10.434 6.216a1.116 1.116 0 0 0-.056-1.594 1.086 1.086 0 0 0-1.918.742 1.1 1.1 0 0 0 .38.786 1.125 1.125 0 0 0 1.594.066" fill="none" />
                        </svg>
                        <span class="bg-white bg-clip-text text-transparent font-medium">Trusted by Experts</span>
                    </div>
                    <h2 class="text-2xl md:text-4xl font-medium mt-2">
                        Unlock Your Potential with 
                            <span class="bg-gradient-to-r from-blue-500 to-blue-300 bg-clip-text text-transparent">Expert Guidance</span>
                            & Proven Results!
                    </h2>
                    <p class="text-slate-800 mt-2 max-w-lg max-md:text-sm">Achieve your goals faster with personalized strategies, hands-on support, and results that speak for themselves.</p>
                    <button type="button" class="bg-gradient-to-r from-[#3f5965] to-[#289db9] text-white text-sm px-5 py-2.5 rounded-xl font-medium mt-4 hover:scale-105 active:scale-95 transition-all duration-300">
                        Get Started Today
                    </button>
                </div>
            </div>
