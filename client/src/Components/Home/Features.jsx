...
const Features = () => {
  ...
  return (
    <div id='features' className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <Title title='Build your resume' description='Resumify.AI is an AI-powered resume builder that converts your experience, skills, and achievements into recruiter-ready resumes — beautifully structured, keyword-optimized, and tailored to the roles you want.'/>
